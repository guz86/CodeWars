...
namespace HouseNumbersSum
{
    ...
    /*
     Task
        ...
        that he passes by during his walk. 
        Unfortunately, not all of the houses have numbers written on them, and on top
         of that the boy is regularly taking turns to change streets, so the numbers
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(HouseNumbersSum(inputArray));
        ...
        //  public int HouseNumbersSum(int[] input) => input.TakeWhile(x => x != 0).Sum();
